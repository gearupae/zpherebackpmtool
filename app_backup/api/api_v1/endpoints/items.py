...
async def get_item_stats(
    ...
    stats_query = select(
        ...
        func.sum(func.case((ItemModel.is_active == True, 1), else_=0)).label("active"),
        func.sum(func.case((ItemModel.item_type == "service", 1), else_=0)).label("services"),
        func.sum(func.case((ItemModel.item_type == "product", 1), else_=0)).label("products"),
        func.sum(func.case(
